...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        # get rid of some of the strides 
        ...
        #self.layer3 = self._make_layer(block, 128, layers[1])
        #self.layer4 = self._make_layer(block, 256, layers[2])
        
        
        
        #banckend and output layers of CSRNet
        ...
        #load resnet weights
        #34 layer - 180, 18 layer - 100, 18-layer last one stride 2 - 75
        for i in xrange(75):
